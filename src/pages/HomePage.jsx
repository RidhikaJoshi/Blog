...
function HomePage() {
 ...
 <p className='italic text-center text-white md:text-2xl text-xl'>Explore our collection of blogs, share your own tales. Let's make writing fun and easy for everyone!"</p>
      ...
      {/* // Performance div */}
        <div className='min-h-[75vh] w-[90%] flex flex-col items-center justify-center text-xl font-medium gap-10 text-white'>
        ...
        <div className='text-white min-h-[50vh] w-full flex md:flex-row flex-col gap-4 justify-between'>
        {/* // Div contains text */}
